...
using DX.Loan.Dto;
using DX.Loan.Net.MimeTypes;
using OfficeOpenXml;

namespace DX.Loan.DataExporting.Excel.EpPlus
{
    public abstract class EpPlusExcelExporterBase : LoanServiceBase, ITransientDependency
    {
