...
using DX.Loan.Web.App.Startup;//SPA!
using DX.Loan.Web.Areas.Mpa.Startup;//MPA!
using DX.Loan.Web.Bundling;
using DX.Loan.Web.Navigation;
using DX.Loan.Web.Routing;
using DX.Loan.WebApi;
...
namespace DX.Loan.Web
{
    ...
    public class LoanWebModule : AbpModule
    {
