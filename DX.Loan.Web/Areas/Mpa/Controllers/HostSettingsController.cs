...
using DX.Loan.Configuration.Host;
using DX.Loan.Editions;
using DX.Loan.Timing;
using DX.Loan.Timing.Dto;
using DX.Loan.Web.Areas.Mpa.Models.HostSettings;
...
namespace DX.Loan.Web.Areas.Mpa.Controllers
{
    ...
    public class HostSettingsController : LoanControllerBase
    {
