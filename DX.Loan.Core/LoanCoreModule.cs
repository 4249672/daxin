...
namespace DX.Loan
{
    ...
    public class LoanCoreModule : AbpModule
    {
        public override void PreInitialize()
        {
            ...
            //Configuration.MultiTenancy.IsEnabled = LoanConsts.MultiTenancyEnabled;
            ...
            Configuration.ReplaceService(typeof(IEmailSenderConfiguration), () =>
             {
                Configuration.IocManager.IocContainer.Register(
                    ...
                    .ImplementedBy<LoanSmtpEmailSenderConfiguration>()
                    .LifestyleTransient()
                );
            });
